  ...
  try {
    ...
    if (
      ...
      const keyboard = new InlineKeyboard()
        ...
        .row()
        .url("👥 Join Group", "https://t.me/Zami_Tech_Group_1")
        .row()
        .url("👥 Join Channel", "https://t.me/Zami_MD_Updates")
        .row()
        .url("👥 Subscribe Yt Developer", "https://youtube.com/@zami-tech-001?si=87rMXvoHrg4e-8tM");
...
bot.on("message", async (ctx) => {
  try {
    ...
    if (!hasAccess(userId)) {
    return ctx.reply("🚫 You are not authorized to use this command.\n📩 Please contact the developer to buy: @ZAMI_WOLF_001💰 Price/Dam: \n✅ Permanent Access: 10$ \n✅ Permanent Reseller: 25$ \n✅ Script (No Encryption, 100%): 60$");
  }
    switch (command) {
      case "start": {
        const username = ctx.from.username
...
<b><i>{❓} ZAMI bot bug say hello ${username}</i></b>

<b>「 🩸⃟༑‣ZAMI 𝐇𝐀𝐂𝐊𝐄𝐑 𝐁͢𝐔𝐆 𝐁͢𝐎𝐓 ☇ 𝐂𝐨𝐫𝐞˚𝐒𝐲𝐬𝐭𝐞𝐦📟  」</b>
⬡ Dev: @ZAMI_WOLF_001 
⬡ Run Time: ${uptime}
⬡ Memory: ${usedMemory}
...
<b>📞 Support</b>
Contact @ZAMI_WOLF_001 for assistance
</blockquote>`.trim();
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {
                            text: "👀 ćhannal",
                            url: "https://t.me/Zami_Tech_Official_1",
                        },
                        {
                            text: "👤 owner ",
                            url: "https://t.me/ZAMI_WOLF_001",
                        },
                    ],
                ],
            },
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {
                            text: "👀 ćhannal",
                            url: "https://t.me/Zami_MD_Updates",
                        },
                        {
                            text: "👤 owner ",
                            url: "https://t.me/ZAMI_WOLF_001",
...
case "b-iosking": {
    try {
        ...
        await ctx.replyWithPhoto(imageMenu, {
            caption:
                "<b>「🩸⃟༑‣𝐙𝐀𝐌𝐈 𝐖𝐎𝐋𝐅 𝐁͢𝐔𝐆 𝐁͢𝐎𝐓 ☇ 𝐁𝐮𝐠˚𝐒𝐲𝐬𝐭𝐞𝐦🦠  」</b>\n" +
                `👤 <b>target :</b> <code>${cleanTarget}</code>\n` +
                `🎭 <b>type bug:</b> <code>crash andro</code>\n` +
                "📊 <b>status:</b> <code>🦠 succes executions</code>\n\n" +
                `<b>📞 Support</b>\nContact @ZAMI_WOLF_001 for assistance`,
...
case "b-fcrelog": {
    ...
    ctx.reply(
        "🔒 <b>Free Mode nonaktifkan</b>\nOnly premium users, owner atau reseller can use the bot.\nIf you want to buy premium DM dev <a href='https://t.me/ZAMI_WOLF_001'>@ZAMI_WOLF_001</a>",
        { parse_mode: "HTML" }
    );
}
...
bot.callbackQuery("open_allaccess", async (ctx) => {
  try {
    ...
    const caption = `<blockquote>
<b><i>{❓} ZAMIsay hello ${userDisplay}</i></b>

<b>「🩸⃟༑‣𝐙𝐀𝐌𝐈 𝐖𝐎𝐋𝐅 𝐁͢𝐔𝐆 𝐁͢𝐎𝐓 ☇ 𝐂𝐨𝐫𝐞˚𝐒𝐲𝐬𝐭𝐞𝐦📟 」</b>
⬡ Dev: @ZAMI_WOLF_001
⬡ Run Time: ${uptime}
⬡ mode : VIP 
⬡ Memory: ${usedMemory}
...
<b>📞 Support</b>
Contact @ZAMI_WOLF_001 for assistance</blockquote>`.trim();
...
bot.callbackQuery("bug_spam", async (ctx) => {
  try {
    ...
    await ctx.answerCallbackQuery();
    const caption = `<blockquote>
<b><i>{❓} ZAMI say hello ${userDisplay}</i></b>
...
bot.callbackQuery("back_to_main", async (ctx) => {
  try {
    ...
    const caption = `<blockquote>
<b><i>{❓} ZAMI say hello ${username}</i></b>
